...
from frenet_local_planner import FrenetLocalPlanner
...
class BasicAgent(Agent):
    ...
    def __init__(self, role_name, ego_vehicle_id, avoid_risk=True):
        ...
        self._local_planner = MyLocalPlanner(role_name, opt_dict={'lateral_control_dict': args_lateral_dict})

        # self._local_planner = FrenetLocalPlanner(role_name,
        #                                    opt_dict={'lateral_control_dict': args_lateral_dict})
