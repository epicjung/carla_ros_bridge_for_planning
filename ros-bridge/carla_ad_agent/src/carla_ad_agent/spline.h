...
//     ros::NodeHandle nh;
//     ros::Subscriber spline_info_subscriber;
...
// std::pair<std::vector<double>, std::vector<double>> spline::convert_cartesian(double s_start, double s_end, double cx, double cy, double yaw)
// {
//     // clock_t start = clock();
//     double point_x = cx;
//     double point_y = cy;
...
//     for(double s0 = s_start; s0 <= s_end; s0 = s0 + ds_)
//     {
