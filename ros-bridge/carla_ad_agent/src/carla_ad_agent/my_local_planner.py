...
class MyLocalPlanner(object):
    ...
    def run_step(self, target_speed):
        ...
        self.get_obstacles(self._current_pose.position, 70.0)

        # Example 1: get two waypoints on the left and right w.r.t current pose
        '''
        left, right = self.get_coordinate_lanemarking(self._current_pose.position)
